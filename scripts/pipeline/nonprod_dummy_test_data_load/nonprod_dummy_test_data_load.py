...
def generate_nonprod_dummy_test_data_json(file_path, table_name):
...
def format_dynamodb_json(csvreader, table_name):
    ...
    for row in csvreader:
        if(str(row[0]) != 'nhs_number') and len(row) == 24:
                print(row)
...
if __name__ == "__main__":
    ...
    file_input_path_1 = "/nonprod-dummy-test-data/dummyDataMaleUpdated.csv"
    # file_input_path_2 = "./nonprod-dummy-test-data/dummyDataFemaleUpdated.csv"
    # test = "./nonprod-dummy-test-data/test.csv"

    path_to_file_1 = os.getcwd() + file_input_path_1
    # path_to_file_2 = os.getcwd() + file_input_path_2

    generate_nonprod_dummy_test_data_json(path_to_file_1, "Population")
    # generate_nonprod_dummy_test_data_json(path_to_file_2, "Population")
    # generate_nonprod_dummy_test_data_json(test, "Population")
