...
def create_data_set(table_name):
  ...
  for i in range(1, 10):
    ...
    address = f'{str(i)} {str(random_word)} {random.choice(street_variation)} , {random.choice(cities)} {postcode}'
    ...
    week_capacity = [random.randint(0,100), random.randint(0,100), random.randint(0,100), random.randint(0,100), random.randint(0,100), random.randint(0,100)]
