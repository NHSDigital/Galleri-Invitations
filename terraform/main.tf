...
module "galleri_invitations_screen" {
  ...
  USERS                                                 = var.USERS
  CIS2_ID                                               = data.aws_secretsmanager_secret_version.cis2_client_id_latest.secret_string
  NEXTAUTH_URL                                          = var.NEXTAUTH_URL
  CIS2_REDIRECT_URL                                     = var.CIS2_REDIRECT_URL
  GALLERI_ACTIVITY_CODE                                 = data.aws_secretsmanager_secret_version.galleri_activity_code_latest.secret_string
