...
# resource "kubernetes_manifest" "configmap_mesh_sandbox_mailboxes" {
#   manifest = {
#     "apiVersion" = "v1"
#     "data" = {
#       "mailboxes.jsonl" = <<-EOT
...
# resource "kubernetes_manifest" "deployment_mesh_sandbox_deployment" {
#   manifest = {
#     "apiVersion" = "apps/v1"
#     "kind"       = "Deployment"
#     "metadata" = {
...
# resource "kubernetes_manifest" "service_mesh_sandbox_service" {
#   manifest = {
#     "apiVersion" = "v1"
#     "kind"       = "Service"
#     "metadata" = {
...
# resource "kubernetes_manifest" "deployment_fhir_validator" {
#   manifest = {
#     "apiVersion" = "apps/v1"
#     "kind"       = "Deployment"
#     "metadata" = {
...
# resource "kubernetes_manifest" "service_fhir_validator" {
#   manifest = {
#     "apiVersion" = "v1"
#     "kind"       = "Service"
#     "metadata" = {
...
resource "null_resource" "deploy_manifests" {
  ...
  provisioner "local-exec" {
    command = "kubectl apply -f ./scripts/test_data/k8s/fhir-validation.yaml"
    # environment = {
