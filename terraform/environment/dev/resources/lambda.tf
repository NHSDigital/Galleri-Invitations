...
data "archive_file" "data_filter_gridall_imd_lambda" {
  ...
  source_file = "/home/runner/work/Galleri-Invitations/Galleri-Invitations/terraform/environment/dev/imdGridal/dataFilterLambda"
  output_path = "/home/runner/work/Galleri-Invitations/Galleri-Invitations/terraform/environment/dev/imdGridal/dataFilterLambda.zip"
}
