...
export const processingData = async (incomingUpdateData, populationTableRecord) => {
  ...
  // Our update is essentially an overwrite, this is because there are cases where the primary key must change
  // as a result of the logic that must be followed due upon certain attributes changing. In order to make our "update"
  // generic and overwrite is implemented.
